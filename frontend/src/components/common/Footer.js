      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Your favorite food delivered fast and fresh. Connecting you with the best restaurants in your area.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/restaurants" className="text-gray-400 hover:text-white transition duration-200">
                  Browse Restaurants
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/restaurant/signup" className="text-gray-400 hover:text-white transition duration-200">
                  Restaurant Signup
                </Link>
              </li>
              <li>
                <Link to="/delivery/signup" className="text-gray-400 hover:text-white transition duration-200">
                  Become a Driver
                </Link>
              </li>
              <li>
                <Link to="/business" className="text-gray-400 hover:text-white transition duration-200">
                  Business Solutions
                </Link>
              </li>
              <li>
                <Link to="/api" className="text-gray-400 hover:text-white transition duration-200">
                  API Documentation
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 FoodDelivery Platform. All rights reserved.
          </p>
